  ...
  <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 280 }}>
    <thead>
      <tr style={{ background: "var(--th-primary)" }}>
        <th style={{ padding: "10px 8px", textAlign: "left", fontSize: 11, fontWeight: 700, color: "var(--th-text-sub)", width: 80 }}>{t('scoreSheet', 'category')}</th>
        {players.map(p => (
          <th key={p.memberId} style={{ padding: "10px 4px", textAlign: "center", fontSize: 12, fontWeight: 800, color: "var(--th-card)", minWidth: 64 }}>
            {p.nickname}
          </th>
        ))}
      </tr>
